...
public class StreamingCreditScores_v5 {
    ...
    public static void main(String[] args) {
        ...
        // Renaming columns using position-based mapping
        Table creditDetailsTable = tableEnv.fromDataStream(creditStream, $("ID"), $("LoanStatus"));
